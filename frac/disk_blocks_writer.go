...
func (w *DiskBlocksWriter) writeIDsBlocks(zstdLevel int, generateBlocks func(func(*ids.DiskIDsBlock) error) error) ([]seq.ID, error) {
	...
	push := func(block *ids.DiskIDsBlock) error {
