...
var file_storeapi_store_api_proto_rawDesc = string([]byte{
	...
	0x69, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0xfa,
	...
	0x72, 0x61, 0x6d, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x42, 0x0e, 0x0a, 0x0c, 0x5f,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x30, 0x0a, 0x0a, 0x49, 0x64, 0x57, 0x69, 0x74,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x10, 0x03, 0x32, 0xbd, 0x04, 0x0a,
...
var file_storeapi_store_api_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_storeapi_store_api_proto_goTypes = []any{
	...
	(*SearchResponse_Bin)(nil),             // 25: api.SearchResponse.Bin
	(*SearchResponse_Agg)(nil),             // 26: api.SearchResponse.Agg
	nil,                                    // 27: api.SearchResponse.HistogramEntry
	nil,                                    // 28: api.SearchResponse.Agg.AggEntry
	nil,                                    // 29: api.SearchResponse.Agg.AggHistogramEntry
	(*FetchRequest_FieldsFilter)(nil),      // 30: api.FetchRequest.FieldsFilter
...
var file_storeapi_store_api_proto_depIdxs = []int32{
	...
	27, // 4: api.SearchResponse.histogram:type_name -> api.SearchResponse.HistogramEntry
	26, // 5: api.SearchResponse.aggs:type_name -> api.SearchResponse.Agg
	2,  // 6: api.SearchResponse.code:type_name -> api.SearchErrorCode
	9,  // 7: api.SearchResponse.explain:type_name -> api.ExplainEntry
	31, // 8: api.ExplainEntry.duration:type_name -> google.protobuf.Duration
	9,  // 9: api.ExplainEntry.children:type_name -> api.ExplainEntry
	31, // 10: api.StartAsyncSearchRequest.retention:type_name -> google.protobuf.Duration
	...
	32, // 15: api.FetchAsyncSearchResultResponse.started_at:type_name -> google.protobuf.Timestamp
	32, // 16: api.FetchAsyncSearchResultResponse.expires_at:type_name -> google.protobuf.Timestamp
	32, // 17: api.FetchAsyncSearchResultResponse.canceled_at:type_name -> google.protobuf.Timestamp
	...
	30, // 20: api.FetchRequest.fields_filter:type_name -> api.FetchRequest.FieldsFilter
	32, // 21: api.StatusResponse.oldest_time:type_name -> google.protobuf.Timestamp
	22, // 22: api.SearchResponse.IdWithHint.id:type_name -> api.SearchResponse.Id
	32, // 23: api.SearchResponse.Bin.ts:type_name -> google.protobuf.Timestamp
	24, // 24: api.SearchResponse.Bin.hist:type_name -> api.SearchResponse.Histogram
	28, // 25: api.SearchResponse.Agg.agg:type_name -> api.SearchResponse.Agg.AggEntry
	29, // 26: api.SearchResponse.Agg.agg_histogram:type_name -> api.SearchResponse.Agg.AggHistogramEntry
	25, // 27: api.SearchResponse.Agg.timeseries:type_name -> api.SearchResponse.Bin
	...
	33, // 37: api.StoreApi.Bulk:output_type -> google.protobuf.Empty
