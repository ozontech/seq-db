...
var filter_SeqProxyApi_GetAsyncSearchesList_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func request_SeqProxyApi_GetAsyncSearchesList_0(ctx context.Context, marshaler runtime.Marshaler, client SeqProxyApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_SeqProxyApi_GetAsyncSearchesList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterSeqProxyApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SeqProxyApiServer) error {
	...
	mux.Handle(http.MethodGet, pattern_SeqProxyApi_GetAsyncSearchesList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/seqproxyapi.v1.SeqProxyApi/GetAsyncSearchesList", runtime.WithHTTPPathPattern("/async-searches"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSeqProxyApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SeqProxyApiClient) error {
	...
	mux.Handle(http.MethodGet, pattern_SeqProxyApi_GetAsyncSearchesList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/seqproxyapi.v1.SeqProxyApi/GetAsyncSearchesList", runtime.WithHTTPPathPattern("/async-searches"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_SeqProxyApi_GetAsyncSearchesList_0   = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"async-searches"}, ""))
)
