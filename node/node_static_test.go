...
func TestStaticDescNextGeq_WithThreshold(t *testing.T) {
	...
	id := n.NextGeq(NewLIDOrderDesc(8))
	assert.False(t, id.IsNull())
	assert.Equal(t, uint32(7), id.Unpack())
