...
func New(ctx context.Context, cfg *Config, s3cli *s3.Client, docsFilter DocsFilter) (*FracManager, func(), error) {
	...
	provider := newFractionProvider(cfg, s3cli, cache, readLimiter, idx, docsFilter)
