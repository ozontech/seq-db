...
func New(ctx context.Context, cfg *Config, s3cli *s3.Client, filterManager FilterManager) (*FracManager, func(), error) {
	...
	provider := newFractionProvider(cfg, s3cli, cache, readLimiter, idx, filterManager)
